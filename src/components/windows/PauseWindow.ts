...
export class PauseWindow extends Window {
    ...
    override createContent() {
        ...
        const guideButton = new Button('Hướng Dẫn', () => this.views.show(Windows.info));
        const rankButton = new Button('Xếp Hạng', () => this.views.show(Windows.info));
        const caidatButton = new Button('Cài Đặt', () => this.views.show(Windows.settings));
        ...
        this.addContent({
            ...
            menu: {
                ...
                content: {
                    ...
                    play: {
                        // replay is the id of the button
                        content: playButton, // content is the button component
                        styles: {
                            // styles is an object with all the styles that will be applied to the button
                            marginTop: 10, // move the button 10px down from the neighbour buttons
                        },
                    ...
                    guide: {
                        // exit is the id of the button
                        content: guideButton, // content is the button component
                        styles: {
                            // styles is an object with all the styles that will be applied to the button
                            marginTop: 10, // move the button 10px down from the neighbour buttons
                        },
                    ...
                    rank: {
                        // levels is the id of the button
                        content: rankButton, // content is the button component
                        styles: {
                            // styles is an object with all the styles that will be applied to the button
                            marginTop: 10, // move the button 10px down from the neighbour buttons
                        },
                    ...
                    settings: {
                        ...
                        content: caidatButton, // content is the button component
                        styles: {
                            // styles is an object with all the styles that will be applied to the button
                            marginTop: 10, // move the button 10px down from the neighbour buttons
                        },
